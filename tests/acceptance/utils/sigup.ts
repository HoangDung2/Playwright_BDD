...
export default class Sigup {
    ...
    constructor(page: Page) {
        ...
        this.creatSigup=page.locator("a[data-test='signup']");
    }
    async CreatSigup(){
        return this.creatSigup.click();
    }
...
class SigupAssertions {
    ...
    async allElementExits(firstname:string,lastName:string,username:string,password:string,confirmPassword:string) {
           await expect(this.page.usernameIP).toHaveValue(username);
            await expect(this.page.firstnameIP).toHaveValue(firstname);
            await expect(this.page.lastnameIP).toHaveValue(lastName);
            await expect(this.page.passwordIP).toHaveValue(password);
            await expect(this.page.confirmPassIP).toHaveValue(confirmPassword);
    }
